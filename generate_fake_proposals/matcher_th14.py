...
# def max_score(score):
#     cost_matrix = np.array(score)
#     row_ind, col_ind = linear_sum_assignment(cost_matrix)
#     print('row_ind={} col_ind={} total_min={}'.format(row_ind, col_ind, sum(cost_matrix[row_ind,col_ind])))
#
# max_score(
#     [
#     [1,2,3,4],
...
# '''
# 输出为：
# row_ind=[0 1 2 3] col_ind=[3 2 1 0] total_min=19
# '''
